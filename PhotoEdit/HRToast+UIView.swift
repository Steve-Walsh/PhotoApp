...
public extension UIView {
    ...
    *  public methods
    */
    class func hr_setToastThemeColor() {
        let color = UIColor(red: 22/255, green: 160/255, blue: 133/255, alpha: 1.0)
    ...
    class func hr_toastThemeColor() -> UIColor {
        ...
        if color == nil {
            color = UIColor(red: 22/255, green: 160/255, blue: 133/255, alpha: 1.0)
            UIView.hr_setToastThemeColor()
        }
        return color!
    }
